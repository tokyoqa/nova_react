    ...
    <div className="ident_container">
      <Card className="card-container-ident">
        ...
        <CardContent sx={{fontSize: "20px", textAlign: 'center'}}>
          <Typography sx={{fontSize: "20px", textAlign: "center", marginBottom: "20px"}} variant="h5"
          ...
          <IMaskInput
            ...
            autoComplete="off"
          />
          <Button color="success" sx={{justifyContent: 'center', marginTop: '15px', width: '60%', borderRadius: "15px"}}
                  variant="contained" onClick={postSecureCode}>
            Продолжить
          </Button>
          <Button disabled={isDisabled} color="success"
                  sx={{justifyContent: 'center', marginTop: '15px', width: '60%', borderRadius: "15px"}}
                  variant="outlined" onClick={resendNumber}>
            Отправить снова
          </Button>
        </CardContent>
